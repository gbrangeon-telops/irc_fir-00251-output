...
add wave -noreg -logic {/fb_intf_tb/DUT/CTRL/MM2S_ERR}
add wave -noreg -logic {/fb_intf_tb/DUT/CTRL/S2MM_ERR}
add wave -named_row "FSM"
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/FSM/AXIS_S2MM_CMD_MOSI}
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/FSM/AXIS_S2MM_CMD_MISO}
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/FSM/AXIS_S2MM_STS_MOSI}
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/FSM/AXIS_S2MM_STS_MISO}
...
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/FSM/FRAME_SIZE}
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/FSM/HDR_SIZE}
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/FSM/IMG_SIZE}
...
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/FSM/s2mm_err}
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/FSM/mm2s_err}
add wave -noreg {/fb_intf_tb/U3/PIXEL_CNT}
...
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/FSM/s_s2mm_cmd_tag}
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/FSM/s_s2mm_saddr}
add wave -noreg -logic {/fb_intf_tb/DUT/FSM/s_s2mm_eof}
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/FSM/s_s2mm_btt}
add wave -noreg -literal {/fb_intf_tb/DUT/FSM/write_state}
add wave -noreg -literal {/fb_intf_tb/DUT/FSM/read_state}
add wave -noreg -logic {/fb_intf_tb/DUT/FSM/new_img_rdy}
...
add wave -noreg -logic {/fb_intf_tb/DUT/DM/fb_datamover/U0/m_axi_s2mm_aclk}
add wave -noreg -logic {/fb_intf_tb/DUT/DM/fb_datamover/U0/m_axi_s2mm_aresetn}
add wave -noreg -logic {/fb_intf_tb/DUT/DM/fb_datamover/U0/s2mm_halt}
add wave -noreg -logic {/fb_intf_tb/DUT/DM/fb_datamover/U0/s2mm_halt_cmplt}
add wave -noreg -logic {/fb_intf_tb/DUT/DM/fb_datamover/U0/s2mm_err}
add wave -noreg -logic {/fb_intf_tb/DUT/DM/fb_datamover/U0/m_axis_s2mm_cmdsts_awclk}
add wave -noreg -logic {/fb_intf_tb/DUT/DM/fb_datamover/U0/m_axis_s2mm_cmdsts_aresetn}
add wave -noreg -logic {/fb_intf_tb/DUT/DM/fb_datamover/U0/s_axis_s2mm_cmd_tvalid}
add wave -noreg -logic {/fb_intf_tb/DUT/DM/fb_datamover/U0/s_axis_s2mm_cmd_tready}
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/DM/fb_datamover/U0/s_axis_s2mm_cmd_tdata}
add wave -noreg -logic {/fb_intf_tb/DUT/DM/fb_datamover/U0/m_axis_s2mm_sts_tvalid}
add wave -noreg -logic {/fb_intf_tb/DUT/DM/fb_datamover/U0/m_axis_s2mm_sts_tready}
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/DM/fb_datamover/U0/m_axis_s2mm_sts_tdata}
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/DM/fb_datamover/U0/m_axis_s2mm_sts_tkeep}
add wave -noreg -logic {/fb_intf_tb/DUT/DM/fb_datamover/U0/m_axis_s2mm_sts_tlast}
add wave -noreg -logic {/fb_intf_tb/DUT/DM/fb_datamover/U0/s2mm_allow_addr_req}
add wave -noreg -logic {/fb_intf_tb/DUT/DM/fb_datamover/U0/s2mm_addr_req_posted}
add wave -noreg -logic {/fb_intf_tb/DUT/DM/fb_datamover/U0/s2mm_wr_xfer_cmplt}
add wave -noreg -logic {/fb_intf_tb/DUT/DM/fb_datamover/U0/s2mm_ld_nxt_len}
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/DM/fb_datamover/U0/s2mm_wr_len}
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/DM/fb_datamover/U0/m_axi_s2mm_awid}
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/DM/fb_datamover/U0/m_axi_s2mm_awaddr}
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/DM/fb_datamover/U0/m_axi_s2mm_awlen}
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/DM/fb_datamover/U0/m_axi_s2mm_awsize}
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/DM/fb_datamover/U0/m_axi_s2mm_awburst}
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/DM/fb_datamover/U0/m_axi_s2mm_awprot}
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/DM/fb_datamover/U0/m_axi_s2mm_awcache}
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/DM/fb_datamover/U0/m_axi_s2mm_awuser}
add wave -noreg -logic {/fb_intf_tb/DUT/DM/fb_datamover/U0/m_axi_s2mm_awvalid}
add wave -noreg -logic {/fb_intf_tb/DUT/DM/fb_datamover/U0/m_axi_s2mm_awready}
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/DM/fb_datamover/U0/m_axi_s2mm_wdata}
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/DM/fb_datamover/U0/m_axi_s2mm_wstrb}
add wave -noreg -logic {/fb_intf_tb/DUT/DM/fb_datamover/U0/m_axi_s2mm_wlast}
add wave -noreg -logic {/fb_intf_tb/DUT/DM/fb_datamover/U0/m_axi_s2mm_wvalid}
add wave -noreg -logic {/fb_intf_tb/DUT/DM/fb_datamover/U0/m_axi_s2mm_wready}
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/DM/fb_datamover/U0/m_axi_s2mm_bresp}
add wave -noreg -logic {/fb_intf_tb/DUT/DM/fb_datamover/U0/m_axi_s2mm_bvalid}
add wave -noreg -logic {/fb_intf_tb/DUT/DM/fb_datamover/U0/m_axi_s2mm_bready}
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/DM/fb_datamover/U0/s_axis_s2mm_tdata}
add wave -noreg -hexadecimal -literal {/fb_intf_tb/DUT/DM/fb_datamover/U0/s_axis_s2mm_tkeep}
add wave -noreg -logic {/fb_intf_tb/DUT/DM/fb_datamover/U0/s_axis_s2mm_tlast}
add wave -noreg -logic {/fb_intf_tb/DUT/DM/fb_datamover/U0/s_axis_s2mm_tvalid}
