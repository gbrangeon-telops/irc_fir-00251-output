...
############## FLASH MEM ############################
set_property IOSTANDARD LVCMOS33 [get_ports QSPI_PROM_IO0]
set_property PACKAGE_PIN B24 [get_ports QSPI_PROM_IO0]
set_property IOSTANDARD LVCMOS33 [get_ports QSPI_PROM_IO1]
set_property PACKAGE_PIN A25 [get_ports QSPI_PROM_IO1]
set_property IOSTANDARD LVCMOS33 [get_ports QSPI_PROM_IO2]
set_property PACKAGE_PIN B22 [get_ports QSPI_PROM_IO2]
set_property IOSTANDARD LVCMOS33 [get_ports QSPI_PROM_IO3]
